...
%  All rights reserved. 
%  Credit to Sadray; code developed from text.

clc;clear;
N = 1; % (number of segments-1)
S = 3.6736; % m^2
AR = 3; % Aspect ratio
...
theta = pi/(2*N):pi/(2*N):pi/2; alpha=a_h+alpha_twist:-alpha_twist/(N-1):a_h; % segment's angle of attack z = (b/2)*cos(theta);
